    ...
    return (
        <div className="py-10 px-4 sm:px-6 lg:px-8">
            <div className="w-96 mx-auto bg-white shadow-md rounded-md p-6 border border-blue-200">
                <h2 className="text-2xl font-bold mb-6 text-center text-orange-500">Confirm Your Book Borrowing</h2>
                ...
                <Form {...form}>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-orange-500 hover:bg-red-400 text-white cursor-pointer">
                            Confirm Borrow
                        </Button>
                    </form>
                </Form>
